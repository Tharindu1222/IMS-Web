...
function Hero(){
  return (
    ...
    px-[20px] flex justify-between items-center lg:flex-row 
    flex-col lg:gap-5 gap-[50px] bg-cover bg-center' style={{backgroundImage: `url(${bacgroundimage})`}}>
      ...
      className='lg:w-[60%] w-full flex flex-col justify-center items-start lg:gap-8 gap-4' >
        ...
        Official Distributor for Carboline Paints & related Products in Sri Lanka</p>
